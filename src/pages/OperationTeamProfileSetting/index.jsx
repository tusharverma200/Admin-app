...
const OperationTeamProfileSettingPage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 font-roboto h-[1024px] mx-auto pt-[37px] relative w-full">
        ...
        <div className="absolute bottom-[0] font-sanchez h-[934px] left-[0] md:px-5 w-[19%]">
          <Sidebar
          ...
          >
            <Img
              className="h-5 md:ml-[0] ml-[38px] mr-[181px] mt-[101px]"
            ...
            >
              ...
              >
                <Text
                  className="common-pointer mb-[155px] md:text-[22px] sm:text-xl"
...
export default OperationTeamProfileSettingPage;
