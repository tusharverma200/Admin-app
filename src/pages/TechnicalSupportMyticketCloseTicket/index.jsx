...
const TechnicalSupportMyticketCloseTicketPage = () => {
  return (
    <>
      <div className="bg-white-A700 font-sanchez h-[1024px] mx-auto relative w-full">
        <div className="h-[1024px] sm:h-[1966px] md:h-[2664px] m-auto md:px-5 w-full">
          <div className="flex h-[1024px] sm:h-[1966px] md:h-[2664px] justify-end m-auto w-full">
          ...
          <Img
            ...
            src="images/img_menubox_934x249.png"
            alt="menubox"
          />
        </div>
        <div className="absolute bg-black-900_70 flex md:flex-col flex-row md:gap-5 h-max inset-[0] items-start justify-center m-auto p-[19px] w-full">
          <div className="flex md:flex-1 flex-col items-center justify-start mb-[157px] md:mt-0 mt-[249px] md:px-5 w-[62%] md:w-full">
          ...
          <div className="flex md:flex-1 flex-col font-roboto items-center justify-start md:ml-[0] ml-[61px] md:mt-0 mt-2 md:px-5 w-[7%] md:w-full">
            <div
          ...
          <Img
            className="h-[30px] md:ml-[0] ml-[17px] md:mt-0 mt-[11px]"
            src="images/img_vector.svg"
            alt="vector"
          />
          <Img
            className="h-7 ml-2.5 md:ml-[0] md:mt-0 mt-[11px]"
            src="images/img_lock.svg"
            alt="lock_One"
          />
          <Img
            className="h-[25px] ml-3 md:ml-[0] md:mt-0 mt-4"
...
export default TechnicalSupportMyticketCloseTicketPage;
