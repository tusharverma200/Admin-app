...
const TechnicalSupportMyticketCloseTicketOnePage = () => {
  return (
    <>
      <div className="bg-white-A700 font-sanchez h-[1024px] mx-auto relative w-full">
        <div className="absolute flex h-[1024px] sm:h-[1966px] md:h-[2664px] inset-[0] justify-end m-auto md:px-5 w-full">
          ...
          <div className="absolute bg-white-A700 flex flex-col font-roboto h-full inset-[0] items-center justify-center m-auto w-full">
            <div className="flex flex-col justify-start w-full">
              ...
              <div className="flex flex-col font-roboto items-center justify-start md:ml-[0] ml-[280px] mt-1 w-[76%] md:w-full">
                ...
                <div className="h-[124px] md:h-[125px] sm:h-[830px] relative w-full">
                  <div className="flex flex-col h-full items-center justify-start m-auto w-full">
                    ...
                    >
                      <div className="bg-gray-400_8e flex flex-1 sm:flex-col flex-row sm:gap-5 items-start justify-end my-0 w-full">
                        <Text
                          className="sm:mt-0 mt-[23px] text-2xl md:text-[22px] text-black-900_01 text-center sm:text-xl tracking-[-0.08px] underline"
                          size="txtRobotoRegular24"
                        >
                          1124
                        </Text>
                        ...
                        <Img
                          className="h-[22px] ml-40 sm:ml-[0] sm:mt-0 mt-[19px]"
                          src="images/img_user_black_900_01_22x18.svg"
                          alt="user"
                        />
                        <Img
                          className="h-5 ml-1.5 sm:ml-[0] sm:mt-0 mt-5"
                          src="images/img_user_black_900_01_21x27.svg"
                          alt="user_One"
                        />
                        <Img
                      ...
                      <div className="bg-gray-400_5e flex flex-1 sm:flex-col flex-row sm:gap-5 items-start justify-end my-0 w-full">
                        <Text
                          className="sm:mt-0 mt-[18px] text-2xl md:text-[22px] text-black-900_01 text-center sm:text-xl tracking-[-0.08px] underline"
                          size="txtRobotoRegular24"
                        >
                          1224
                        </Text>
                        ...
                        <Img
                          className="h-[22px] sm:ml-[0] ml-[158px] sm:mt-0 mt-[18px]"
                          src="images/img_user_black_900_01_22x18.svg"
                          alt="user"
                        />
                        <Img
                          className="h-5 ml-1.5 sm:ml-[0] sm:mt-0 mt-[19px]"
                          src="images/img_user_black_900_01_21x27.svg"
                          alt="user_One"
                        />
                        <Img
        ...
        <Img
          ...
          src="images/img_menubox_1.png"
          alt="menubox"
        />
        <div className="absolute bg-black-900_70 flex md:flex-col flex-row md:gap-5 h-full inset-[0] items-start justify-center m-auto p-[34px] sm:px-5 w-full">
          <div className="flex md:flex-1 flex-col items-center justify-start mb-[121px] md:ml-[0] ml-[265px] md:mt-0 mt-[261px] md:px-5 w-[64%] md:w-full">
            <div className="bg-white-A700 border border-black-900_8c border-solid flex flex-col gap-[25px] items-center justify-start p-[41px] md:px-10 sm:px-5 shadow-bs w-full">
              ...
              <div className="bg-cyan-300 flex flex-col font-roboto items-center justify-start mb-16 p-[25px] sm:px-5 rounded-[20px] w-[91%] md:w-full">
                <div className="flex flex-col gap-3 justify-start mb-[30px] mt-[38px] w-[98%] md:w-full">
                  <div className="flex md:flex-col flex-row gap-3 items-start justify-between w-full">
                    ...
                    <div className="flex md:flex-1 flex-col justify-start w-[56%] md:w-full">
                      <TextArea
                        className="bg-white-A700 border-0 pb-[35px] pl-[15px] sm:pr-5 pr-[35px] pt-2.5 rounded-[10px] shadow-bs placeholder:text-black-900_01 text-black-900_01 text-center text-lg tracking-[-0.08px] w-full"
                        name="group263"
                        placeholder="Remark"
                      ></TextArea>
                      <Img
                        className="h-[25px] md:ml-[0] ml-[11px] mt-0.5"
          ...
          <div className="flex md:flex-1 flex-col font-roboto items-center justify-start md:ml-[0] ml-[25px] md:px-5 w-[7%] md:w-full">
            <div
          ...
          <Img
            className="h-[30px] md:ml-[0] ml-[17px] md:mt-0 mt-[3px]"
            src="images/img_vector.svg"
            alt="vector"
          />
          <Img
            className="h-7 ml-2.5 md:ml-[0] md:mt-0 mt-[3px]"
            src="images/img_lock.svg"
            alt="lock_One"
          />
          <Img
            className="h-[25px] ml-3 md:ml-[0] mr-[7px] md:mt-0 mt-2"
            src="images/img_user.svg"
            alt="user_Five"
          />
        </div>
...
export default TechnicalSupportMyticketCloseTicketOnePage;
